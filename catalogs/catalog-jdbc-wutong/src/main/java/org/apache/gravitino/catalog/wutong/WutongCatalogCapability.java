...
public class WutongCatalogCapability implements Capability {
  /**
   ...
   * <p>$ - End of the string
   */
  public static final String WUTONGDB_NAME_PATTERN = "^[_a-zA-Z\\p{L}/][\\w\\p{L}-$/=]{0,62}$";

  @Override
  public CapabilityResult specificationOnName(Scope scope, String name) {
    // TODO: Validate the name against reserved words
    if (!name.matches(WUTONGDB_NAME_PATTERN)) {
