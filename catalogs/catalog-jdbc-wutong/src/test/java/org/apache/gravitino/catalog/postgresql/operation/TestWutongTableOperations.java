...
public class TestWutongTableOperations extends TestPostgreSql {
  ...
  public void testCreateMultipleTable() throws SQLException {
    ...
    wutongSchemaOperations.create(TEST_DB_NAME, null, null);

    WutongTableOperations wutongTableOperations = new WutongTableOperations();

    wutongTableOperations.initialize(
        dataSource,
    ...
    Assertions.assertThrows(
        NoSuchTableException.class, () -> wutongTableOperations.load("other_schema", table_1));
    ...
    TABLE_OPERATIONS.create(
        ...
        Distributions.NONE,
        Indexes.EMPTY_INDEXES);
    tableNames = wutongTableOperations.listTables(TEST_DB_NAME);
    Assertions.assertFalse(tableNames.contains(table_2));

    Assertions.assertThrows(
        NoSuchTableException.class, () -> wutongTableOperations.load(TEST_DB_NAME, table_2));
    Assertions.assertThrows(
        NoSuchTableException.class, () -> wutongTableOperations.load("other_schema", table_2));
    Assertions.assertThrows(
        NoSuchTableException.class, () -> TABLE_OPERATIONS.load("other_schema", table_2));
    wutongTableOperations.drop(TEST_DB_NAME, table_1);

    Assertions.assertThrows(
        NoSuchTableException.class,
        () -> {
          wutongTableOperations.load(TEST_DB_NAME, table_1);
        });
  ...
  public void testAppendIndexesSql() {
    ...
    WutongTableOperations.appendIndexesSql(indexes, successBuilder);
    Assertions.assertEquals(
        ",\n"
    ...
    IllegalArgumentException illegalArgumentException =
        Assertions.assertThrows(
            IllegalArgumentException.class,
            () ->
                WutongTableOperations.appendIndexesSql(
  ...
  public void testOperationIndexDefinition() {
    ...
    String result = WutongTableOperations.addIndexDefinition(tableName, addIndex);
    Assertions.assertEquals(
    ...
    result = WutongTableOperations.addIndexDefinition(tableName, addIndex);
    Assertions.assertEquals(
    ...
    result = WutongTableOperations.deleteIndexDefinition(tableName, deleteIndex);
    Assertions.assertEquals(
  ...
  void testUpdateColumnAutoIncrementDefinition() {
    ...
    String sql =
        WutongTableOperations.updateColumnAutoIncrementDefinition(
