...
import static org.apache.gravitino.catalog.wutong.converter.WutongTypeConverter.ARRAY_TOKEN;
import static org.apache.gravitino.catalog.wutong.converter.WutongTypeConverter.BOOL;
import static org.apache.gravitino.catalog.wutong.converter.WutongTypeConverter.BPCHAR;
import static org.apache.gravitino.catalog.wutong.converter.WutongTypeConverter.BYTEA;
import static org.apache.gravitino.catalog.wutong.converter.WutongTypeConverter.FLOAT_4;
import static org.apache.gravitino.catalog.wutong.converter.WutongTypeConverter.FLOAT_8;
import static org.apache.gravitino.catalog.wutong.converter.WutongTypeConverter.INT_2;
import static org.apache.gravitino.catalog.wutong.converter.WutongTypeConverter.INT_4;
import static org.apache.gravitino.catalog.wutong.converter.WutongTypeConverter.INT_8;
import static org.apache.gravitino.catalog.wutong.converter.WutongTypeConverter.JDBC_ARRAY_PREFIX;
import static org.apache.gravitino.catalog.wutong.converter.WutongTypeConverter.NUMERIC;
...
/** Unit test for {@link org.apache.gravitino.catalog.wutong.converter.WutongTypeConverter}. */
public class TestWutongTypeConverter {

  private static final WutongTypeConverter WUTONGDB_TYPE_CONVERTER = new WutongTypeConverter();
  ...
  public void testFromGravitinoType() {
    ...
    Assertions.assertThrows(
        IllegalArgumentException.class,
        () -> WUTONGDB_TYPE_CONVERTER.fromGravitino(Types.UnparsedType.of(USER_DEFINED_TYPE)));
  }

  protected void checkGravitinoTypeToJdbcType(String jdbcTypeName, Type gravitinoType) {
    Assertions.assertEquals(jdbcTypeName, WUTONGDB_TYPE_CONVERTER.fromGravitino(gravitinoType));
  }
  ...
  protected void checkJdbcTypeToGravitinoType(
    ...
    Assertions.assertEquals(gravitinoType, WUTONGDB_TYPE_CONVERTER.toGravitino(typeBean));
  }
